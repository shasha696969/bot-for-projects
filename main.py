...
def start_command(message):
    bot.send_message(message.chat.id, """Привет! Я твой бот проектов
...
/skills - выбор проекта, для которог нужно добавить навык
/projects - показывает список твоих проектов
/delete - удаляет проект
/update_projects - обновляет проект

Также ты можешь ввести имя проекта и узнать информацию о нем!""")
    
#команда, чтобы спросить название проекта
@bot.message_handler(commands=['new_project'])
def addtask_command(message):
    bot.send_message(message.chat.id, "Введите название проекта:")
    bot.register_next_step_handler(message, name_project)  

#команда, чтобы пользователь ввёл ссылку на проект
...
#команда, чтобы пользователь смог ввести статус проекта
...
#команда, которая выводится, когда пользователь выбрал статус проекта не из списка, и чтобы попробовал ещё раз
...
#команда, которая спрашивает у пользователя для какого проекта нужно выбрать навык
...
#команда, которая выводится, когда пользователь выбрал проект, которого нету
...
#команда, которая выводится, когда пользователь выбрал навык не из списка
...
#команда, которая выводит все проекты пользователя
...
#команда, которая удаляет проект пользователя
...
#команда, которая обновляет проект пользователя
...
#команда, которая спрашивает у пользователя, нужна ли ему помощь
